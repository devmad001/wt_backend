...
def interface_pdfocr(input_pdf,output_pdf,downsample=300,jobs=2):
    ...
    if (downsample and GLOBAL_CONFIG_DOWNSAMPLE) or (dpi>GLOBAL_CONFIG_FORCE_DOWNSAMPLE_IF_OVER):
...
# Example Usage
def interface_downsample_pdf(input_pdf,output_pdf):
    ## Same file
    return
